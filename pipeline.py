...
# Combine df_amazon and df_international into a single DataFrame
df_combined_sales = pd.concat([df_amazon, df_international], ignore_index=True)

print("-" * 20 + " Combined Sales Data Columns:" + "-" * 20)

# Inspect the combined DataFrame
print("\n--- Combined Sales Data ---")
print(df_combined_sales.head())

print("\nInfo of Combined Sales Data:")
print(df_combined_sales.info())

print("\nMissing values in Combined Sales Data:")
print(df_combined_sales.isnull().sum())

print("-" * 20 + " Combined Sales Data Columns:" + "-" * 20)

print("*" * 15 + " Merged DataFrames:" + "*" * 15)

df_final_sales = pd.merge(df_combined_sales, df_sale, on='sku', how='left')

print("\n--- First 5 rows of Final Sales (after product enrichment) ---")
print(df_final_sales.head())

print("\nInfo of Final Merged Sales Data: (after product enrichment)")
print(df_final_sales.info())

print("\nMissing values in Final Merged Sales Data: (after product enrichment)")
